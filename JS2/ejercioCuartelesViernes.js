...
const paddockManagers = [
  ...
  function sortPaddockTypeByTotalArea(){
    console.log(("***********sortPaddocTypeByTotalArea*******"));

    for (let i=0; i<paddockType.length;i++){
        let sumaTotalPorId =0;
        for (let j=0; j<paddocks.length; i++){
...
sortPadockManagerIdByTotalArea();
  //PREGUNTA 3

  //Arreglo con los nombres de los administradores, ordenados decrecientemente 
  // por la suma total de hectareas que administran

  function sortPadockManagerIdByTotalArea(){
    console.log(("***********sortPaddocManagerByTotalArea*******"));
